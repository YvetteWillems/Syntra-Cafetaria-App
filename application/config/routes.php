...
$route['admin/admin_order_update'] = 'admin/admin_order_update'; 
$route['admin/get_todays_order'] = 'admin/get_todays_order'; 
$route['login/logout_user'] = 'login/logout_user'; 
$route['user/history'] = 'user/history'; 
$route['user/update_user'] = 'user/update_user'; 
$route['user/user_details'] = 'user/user_details'; 
